...
import { Shelves } from '@mui/icons-material'
...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { title: 'Stock', icon: <Shelves />, path: '/stock', roles: ['Admin', 'Manager'] },
    { title: 'Suppliers', icon: <ManageAccountsIcon />, path: '/suppliers', roles: ['Admin', 'Manager'] },
