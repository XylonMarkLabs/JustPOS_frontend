        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
          ...
          <Box>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, p: 1.5, border: '1px dashed #d1d5db', borderRadius: 1, backgroundColor: '#f9fafb' }}>
              ...
              ) : product?.image && !product.image.match(/[\u{1f300}-\u{1f5ff}\u{1f900}-\u{1f9ff}\u{1f600}-\u{1f64f}\u{1f680}-\u{1f6ff}\u{2600}-\u{26ff}\u{2700}-\u{27bf}]/u) ? (
                <Avatar
                  src={product.image}
                  sx={{ 
                    width: 50, 
              ...
              <Box sx={{ flex: 1 }}>
                ...
                <label htmlFor="image-upload-edit">
                  ...
                  >
                    {formData.imagePreview || (product?.image && !product.image.match(/[\u{1f300}-\u{1f5ff}\u{1f900}-\u{1f9ff}\u{1f600}-\u{1f64f}\u{1f680}-\u{1f6ff}\u{2600}-\u{26ff}\u{2700}-\u{27bf}]/u)) ? 'Change' : 'Upload'}
                  </Button>
                </label>
